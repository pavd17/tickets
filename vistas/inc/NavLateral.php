	...
	<div class="full-box nav-lateral-content">
		<figure class="full-box nav-lateral-avatar">
			...
			<figcaption class="roboto-medium text-center">
				<?php echo 
				$_SESSION['nombre_spm']." ".$_SESSION['apellido_spm'];?>
		...
		<nav class="full-box nav-lateral-menu">
			<ul>
				...
				<li>
					<a href="#" class="nav-btn-submenu"><i class="fas fa-users fa-fw"></i> &nbsp; Profesores o Estudiantes <i class="fas fa-chevron-down"></i></a>
					<ul>
						<li>
